#!/bin/bash
# =============================================================================
# run_qwen3vl-4b_geoloc_coldstart_v5_8gpu.sh — REVERSE v5 coldstart RL
#
...
# Usage:
#   # Phase 1 (easy)
#   bash script/rl/geoloc/run_qwen3vl-4b_geoloc_coldstart_v5_8gpu.sh
#
#   # Phase 2 (full, override train file)
#   TRAIN_FILE=train_rl_v5_full.parquet bash script/rl/geoloc/run_qwen3vl-4b_geoloc_coldstart_v5_8gpu.sh
#
# Required env:
#   DATA_ROOT  — path to REVERSE/ directory (e.g. /mnt/sh/.../data_agent/REVERSE)
...
# Expand DATA_ROOT in tool config (required for cache_path)
export DATA_ROOT
